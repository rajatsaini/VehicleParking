...
<br>
<br>
     	<font color="black" size="8">Operator Deleted.</font><br>
     	<c:forEach var="operator" items="${allOperators}" varStatus="index">
     	
			<font color="#F08E20" size="6">${operator}</font>
			<br>
				
	  </c:forEach>
	  
	 <div class="myButton"> <a href="deleteUserForm"><font color="blue" size="5"> Delete More Operator(s)</font></a><br></div>
