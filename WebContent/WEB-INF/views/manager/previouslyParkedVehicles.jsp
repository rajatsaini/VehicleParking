...
<br><br><br>
			...
			<th><font color="black" size="4">Exit Time </font></th>
			</tr>
		<c:forEach var="vehicle" items="${previousVehicles}" varStatus="index">
		<tr>
		...
		<td><font color="black" size="4">${vehicle.exitTime}</font></td>
		</tr>
			<br>
