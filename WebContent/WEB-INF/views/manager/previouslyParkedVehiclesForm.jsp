...
<div class="effHeader">
	...
	<form action="previouslyParkedVehicles" method="post" class="form-signin">
	
		<input style="color: black" type="text" name="vehicleRegNo" maxlength="15"placeholder="Enter vehicle Number"/>
		
		<div class="myButton"><input type="submit" value="Find the Details"/></div>
