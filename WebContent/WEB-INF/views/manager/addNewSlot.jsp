...
<div class="effHeader">
    ...
    background-repeat: no-repeat;">
	    ...
	    <br>
	    <br>
	    <h3 style="color:black">${msg} with the Details: </h3><br>
	    <br>
	    <br>
	    <table border="3" align="center" style="background-color: gray; width:60% ">
	    <tr>
	    <th>Slot id</th>
	    <th>vehicle type</th>
	    <th>floor</th>
	    	...
	    	<tr>	
     			<td><font color="black" size="3">${slotId}</font></td>
     			<td><font color="black" size="3">${vehicleType}</font></td>
     			<td><font color="black" size="3">${floor}</font></td>
     			</tr>
     	</table>
     	<br>
     	<br>
     	<a href="addNewSlotForm"><font color="blue" size="3">Add More Slot(s)</font></a><br>
