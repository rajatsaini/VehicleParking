...
<div class="effHeader">
    ...
    background-repeat: no-repeat;">
	    ...
	    <br>
	    <br>
		<font size="5" color="black">${msg}</font>
		<br>
		<br>
		<h3 style="color:#F15D17">Slot Number ${slotId} Unblocked.</h3>   
		<br>
		
		<a href="unblockSlotForm"><font size="3" color="blue">Unblock More Slot(s)</font></a>
				<br>
				<br>
