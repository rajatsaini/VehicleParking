...
<div class="container">
          <div class="inner cover">
           <h3 style="color:red">${msg}</h3>
			<font color="black" size="5">Select Slots to Block</font>
			<div class="button">
				<c:forEach items="${allEmptySlots}" var="slot" begin="0">
				
				<button class="button button5">	<a  href="<c:url value="blockSlotConfirm">
