...
<div class="effHeader">
   ...
   <br>
   <br>
   <font size="5" color="black">Select Operator to Delete</font>
      ...
      <c:forEach var="operator" items="${allOperators}" varStatus="index">
			...
			<br>
			<input  type="checkbox" name="allOperators" checked="checked" value="${operator.userName} "/>
		<font color="black" size="5">${operator.userName}</font>	
			<br>
				
	  </c:forEach>
	<div class="myButton">  <input type="submit" value="Delete Operator(s)"/></div>
	  </form>
