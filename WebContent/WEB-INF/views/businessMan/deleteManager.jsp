...
<div class="effHeader">
	...
	<br>
	    ...
	    <div class="container">
<br>
     	<font size="6" color="black">Manager(s) Deleted.</font><br>
     	<c:forEach var="manager" items="${allManagers}" varStatus="index">
     	
			<font size="5" color="black">${manager}</font>
			<br>
				
	  </c:forEach>
	  <br>
	  <br>
	  <a href="deleteManagerForm"><font size="5" color="blue">Delete More Manager(s)</font></a><br>
